...
from EzilaXBot.modules.helper_funcs.alternate import typing_action

# from EzilaXBot.modules.rules import get_rules
import EzilaXBot.modules.sql.rules_sql as rulessql

# from EzilaXBot.modules.sql import warns_sql as warnssql
import EzilaXBot.modules.sql.blacklist_sql as blacklistsql
from EzilaXBot.modules.sql import disable_sql as disabledsql

# from EzilaXBot.modules.sql import cust_filters_sql as filtersql
# import EzilaXBot.modules.sql.welcome_sql as welcsql
import EzilaXBot.modules.sql.locks_sql as locksql
from EzilaXBot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("EzilaXBot{}.backup".format(chat_id), "w") as f:
    ...
    os.remove("EzilaXBot{}.backup".format(chat_id))  # Cleaning file
